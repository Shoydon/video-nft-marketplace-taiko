  ...
  return (
    <div className='text-white flex justify-around items-center pt-32'>
        ...
        <div className='mb-16 mx-5'>
            ...
            <p className='pt-8 text-xl font-thin'> Non Fungible Tokens (NFTs) are unique digital assets that represent ownership of a specific item,<br/> such as digital art, virtual real estate, or collectibles.<br/> Each NFT has a unique identifier, ensuring its uniqueness and non-interchangeability.</p>
